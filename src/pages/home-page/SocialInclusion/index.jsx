                    ...
                    <div className="thumbnails grid relative grid-cols-1 items-center mx-auto">
                        ...
                        >
                            <div className="relative mx-auto w-full">
                                <img
                                    src="https://cpb-uglsolution-videos.s3-accelerate.amazonaws.com/acciona/FlyThroughThumbnail.jpg"
                ...
                <div className="videoView h-full relative flex flex-col justify-center container">
                    <div className="relative min-[1680px]:w-[65%] min-[1200px]:w-[55%] w-full mx-auto">
                        ...
                        ref={videoRef}
                            ...
                            src="https://cpb-uglsolution-videos.s3-accelerate.amazonaws.com/acciona/Fly-Through_Animatic_v1+(2).mp4"
                            controls
                            poster="https://cpb-uglsolution-videos.s3-accelerate.amazonaws.com/acciona/FlyThroughThumbnail.jpg"
                        />
                        {!isPlaying && (
